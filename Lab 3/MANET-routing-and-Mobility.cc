...
RoutingExperiment::RoutingExperiment()
    : port(9),
      bytesTotal(0),
      packetsReceived(0),
      m_CSVfileName("randomwalk-manet-routing.output.csv"),
...
RoutingExperiment::Run(int nSinks, double txp, std::string CSVfileName)
{
    ...
    std::string mobility_type;
    //mobility_type = "Random Waypoint";
    // mobility_type = "Group";
    mobility_type = "Random Walk";
    if(mobility_type == "Random Waypoint") {
    ...
    } else if (mobility_type == "Random Walk")
    {
        mobilityAdhoc.SetMobilityModel("ns3::RandomWalk2dMobilityModel",
                                       "Speed",
                                       StringValue("ns3::UniformRandomVariable[Min=0.0|Max=20.0]"),
                                       "Bounds",
                                       RectangleValue(Rectangle(0, 300, 0, 1500))
                                       );
    } else if (mobility_type == "Group")
    {
        // Add group mobility code here
    } else {
        NS_FATAL_ERROR("No such mobility model:" << mobility_type);
    }
